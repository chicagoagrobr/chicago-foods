      ...
      <main className="max-w-5xl mx-auto mt-8 mb-12 p-6 space-y-8">
        ...
        <section className="max-w-4xl p-6 bg-white rounded-2xl shadow-xl flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1">
            <h1 className="text-lg xs:text-3xl font-bold mb-4">{name}</h1>
            <p className="text-sm xs:text-lg text-gray-700">{description}</p>
          </div>
        </section>

        <section>
          <p className="text-sm xs:text-lg text-gray-700 text-justify pt-2 pb-2">{longDesc}</p>
        </section>
